...
import type { ClassComponentInterface, Component } from './rendernode/componentrendernode';
...
declare global {
    namespace JSX {
         ...
         * The element type
         */
        type ElementType = Component<any> | Promise<RenderNode> | keyof KnownElements | keyof CustomElements | string;
        /**
