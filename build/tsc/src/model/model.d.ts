...
export declare namespace model {
    var subscribe: <T extends {}, K extends keyof T>(sourceModel: T, handler: (event: ModelEvent<T, K>[]) => void, debugName?: string | undefined) => () => void;
    var field: <T extends {}, K extends keyof T>(sourceModel: T, field: K) => DynamicMut<T[K]>;
}
