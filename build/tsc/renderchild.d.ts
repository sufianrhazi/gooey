...
export declare type Component<P extends {}> = (props: PropsWithChildren<P>, listeners: ComponentListeners) => RenderChild;
declare type JsxRawNode = string | number | boolean | null | undefined | Function;
/**
 * The type returnable by JSX (raw nodes)
 */
declare type RenderChildSingle = JsxRawNode | Calculation<JsxRawNode> | Calculation<JsxRawNode[]> | RenderElement | RenderComponent<any>;
export declare type RenderChild = RenderChildSingle | RenderChildSingle[] | Collection<RenderChildSingle>;
...
export declare function isRenderElement(renderChild: RenderChild): renderChild is RenderElement;
...
export declare function isRenderComponent(renderChild: RenderChild): renderChild is RenderComponent<any>;
export {};
//# sourceMappingURL=renderchild.d.ts.map